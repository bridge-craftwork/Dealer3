...
describe('isGeneratedLeveling', () => {
  it('recognises the block --write-leveled writes', () => {
    const generated = `HandType_A = hcp(south) > 10
### BEGIN GENERATED LEVELING ###
# Generated by dealer --write-leveled. Do not edit; edit the stock
level_A = HandType_A and roll < 559
### END GENERATED LEVELING ###
`
    expect(isGeneratedLeveling(generated)).toBe(true)
  })

  it('does not take a stock placeholder for one', () => {
    const stock = `HandType_A = hcp(south) > 10
### BEGIN GENERATED LEVELING ###
noLeveling = 1
levelTheDeal = noLeveling
### END GENERATED LEVELING ###
`
    expect(isGeneratedLeveling(stock)).toBe(false)
    expect(isGeneratedLeveling('')).toBe(false)
  })
})
