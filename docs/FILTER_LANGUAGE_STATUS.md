...
| `6.25, 3.0, .5` | A decimal is sugar for a hundred times itself: `6.25` is 625, `.5` is 50. DealerV2_4 calls these dotnums and computes them the same way. | `altcount 8 6.25 4.25 1.5 0.75 .25` |
